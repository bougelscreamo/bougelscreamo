...
<ul>
  <li><strong>TeraCMS</strong> 🔒 (Private) — <em>Last active: 2026-09-26</em></li>
  <li><strong>TeraCMS-BE</strong> 🔒 (Private) — <em>Last active: 2026-09-26</em></li>
  <li><strong>NusaNexa-web</strong> 🔒 (Private) — <em>Last active: 2026-09-26</em></li>
  <li><strong>LimaERP-BE</strong> 🔒 (Private) — <em>Last active: 2026-09-25</em></li>
  <li><strong>LimaERP-FE</strong> 🔒 (Private) — <em>Last active: 2026-09-25</em></li>
  <li><strong>RWM-FE</strong> 🔒 (Private) — <em>Last active: 2026-09-25</em></li>
  <li><strong>bougelscreamo</strong> 🌐 (Public) — <em>Last active: 2026-09-25</em></li>
  <li><strong>LimaERP-Wapi</strong> 🔒 (Private) — <em>Last active: 2026-09-24</em></li>
  <li><strong>teraskomputer.id</strong> 🔒 (Private) — <em>Last active: 2026-09-24</em></li>
  <li><strong>RWM-BE</strong> 🔒 (Private) — <em>Last active: 2026-09-23</em></li>
</ul>
<!-- TOP_REPOS_END -->
<p align="center">
  <!-- GitHub Stats Card -->
